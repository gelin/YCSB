...
public abstract class OneMeasurement {
    ...
    public abstract void exportPartMeasurements(MeasurementsExporter exporter) throws IOException;

    public abstract void exportFinalMeasurements(MeasurementsExporter exporter) throws IOException;
}
